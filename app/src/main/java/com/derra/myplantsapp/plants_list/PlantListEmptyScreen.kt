...
@Composable
fun PlantListEmptyScreen(modifier: Modifier = Modifier, viewModel: PlantListViewModel) {
    Column(modifier = modifier
        ...
        Column(modifier = Modifier.padding(44.dp)) {
            Row(modifier = Modifier
                ...
                Text(text = "Sorry.", style = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.SemiBold))
            ...
            Row(modifier = Modifier
                ...
                Text(text = "There are no plants in the list, please add your first plant.", style = TextStyle(fontSize = 14.sp), maxLines = 2)
